...
<body class="font-sans bg-gray-background text-gray-900 text-sm">
    ...
    <main class="container mx-auto max-w-custom flex">
        <div class="w-70 mr-5">Lorem ipsum dolor sit amet consectetur adipisicing elit.
            Add idea form goes here. Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur sit esse
            fugiat est rem aliquam odit nulla obcaecati, alias corporis inventore expedita quasi doloribus sed
            laboriosam, repudiandae praesentium! Nobis, vel!
        </div>
        <div class="w-175">
