<div x-data @click="
    ...
    <div class="hidden md:block border-r border-gray-100 px-5 py-8">
        ...
        <div class="mt-8">
            @if ($hasVoted)
            <button
                class="w-20 bg-blue border text-white border-blue hover:bg-blue-400 font-bold text-xxs uppercase rounded-xl transition duration-150 ease-in px-4 py-3">Voted</button>
            @else
